...
`endif
    ...
    initial begin
        ...
        $display("FEATURE_PASS writes=%0d commits=%0d requests=%0d responses=%0d canceled=%0d overlap=%0d stalls=%0d successes=%0d failures=%0d",writes,commits,requests,responses,canceled,overlap,stalls,successes,failures);$finish;
    end
