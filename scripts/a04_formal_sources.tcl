...
# A04 formal source manifest. Explicit lists only; do not replace with globbing.
...
set a04_sim_sources [list \
    [file join $a04_project_root tb/unit/npu/v13/a04/gemm_feature_timing.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/gemm_feature_transport_timing.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/multik_timing.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/npu_v13_psum_predecode_reference.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/psum_timing.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_feature_count_fence.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_feature_read_pipeline.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_feature_store_capacity.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_feature_store_validation.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_feature_store.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_feature_transport_pack.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_gemm_feature_backend.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_gemm_feature_capacity.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_gemm_feature_transport.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_kchunk_ctrl.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_load_validated_beat.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_multik_backend.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_npu_v13_psum_p4.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_panel_bank_local.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_panel_load_transport.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_post_config_fence.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_psum_panel.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_psum_predecode_equiv.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_psum_read_pipeline.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_quant_cfg_commit.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_quant_params_capacity.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_quant_params.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_requant_credit.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_requant_p4.sv] \
    [file join $a04_project_root tb/unit/npu/v13/a04/tb_requant_product_exact.sv]
]
set a04_xdc_200 [file join $a04_project_root constraints/a04/npu_v13_a04_200m.xdc]
set a04_xdc_300 [file join $a04_project_root constraints/a04/npu_v13_a04_300m.xdc]
set a04_ppa_xdc_200 [file join $a04_project_root constraints/a04/npu_v13_a04_ppa_200m.xdc]
set a04_ppa_xdc_300 [file join $a04_project_root constraints/a04/npu_v13_a04_ppa_300m.xdc]
