...
set report_dir [file join $root_dir reports v13_job_executor_xsim]
...
set tests [list \
    [list tb_npu_v13_job_executor NPU_V13_JOB_EXECUTOR_TB_PASS job_executor.log] \
    [list tb_npu_v13_job_executor_runtime_joint NPU_V13_JOB_EXECUTOR_RUNTIME_JOINT_TB_PASS job_executor_runtime_joint.log]]
...
puts "NPU_MYDESIGN_JOB_EXECUTOR_PROJECT_XSIM_PASS checks=2"
